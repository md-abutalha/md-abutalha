...
- **Test Case Writing**  
  - Project 1: Detailed test case documentation, including test plans and reports.  
  - Project 2: Comprehensive mind maps used to visualize test scenarios.  
  - Project 3: Summary report and metrics derived from test executions.  
  - Project 4: Bug report detailing defects and their resolutions.  

- **JIRA Management**  
  - Project: Management of tasks and bugs using JIRA, creating workflows and reports.  

### Penetration Testing  
- **Penetration Testing Tools Used**  
  - Project: Conducted penetration testing using various tools to identify security vulnerabilities.  

### Web Automation Testing  
- **Technologies**: Selenium, Java, TestNG, Java Faker, Allure, Maven  
  - Project 1: Automated testing suite for web applications using Selenium.  
  - Project 2: TestNG framework implementation for structured test execution.  
  - Project 3: Integration of Allure for enhanced reporting.  

### Industry Project  
- **Hishabee App**  
  - Description: Involvement in testing for the Hishabee application, focusing on various testing methodologies and reporting.  

### API Testing  
- **Technologies**: Postman, Newman  
  - Project 1: API testing using Postman with detailed test cases.  
  - Project 2: Automation of API tests using Newman.  
  - Project 3: Performance validation for various API endpoints.  
  - Project 4: Validation of API response structures and data accuracy.  
  - Project 5: Comprehensive test coverage for multiple APIs.  
  - Project 6: Integration tests for end-to-end validation.  

### Load Testing  
- **Technologies**: Apache JMeter, BlazeMeter  
  - Project 1: Load testing on web applications to assess performance under stress.  
  - Project 2: Analysis of performance metrics generated by JMeter reports.  
  - Project 3: Load testing for Hishabee App with multiple API endpoints.  

### Android Automation Testing  
- **Technologies**: Appium, Selenium, Java, TestNG, Excel, Apache POI  
  - Project 1: Automated UI testing for Android applications using Appium and Java.  
